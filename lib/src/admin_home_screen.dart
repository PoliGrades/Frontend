...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          return DesktopAdminScreen(user: currentUser);
        },
      ),
    );
  }
...
class DesktopAdminScreen extends StatefulWidget {
  const DesktopAdminScreen({super.key, required this.user});
...
class _DesktopAdminScreenState extends State<DesktopAdminScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final courses = coursesController.allCourses;
    final course =
        coursesController.getCourseByName(selectedCourse) ?? courses.first;
    final color = course.color;
    final accentColor = course.accentColor;
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ChatScreen(
                                  recipient: User(
                                    email: 'professor.exemplo@escola.com',
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        "Boas-vindas ${widget.user.name.split(" ")[0]}!!",
                                        style: TextStyle(
                                          fontFamily:
                                  ...
                                  Expanded(
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        final course = coursesController
                                            .getCourseByName(assignment.course);
...
// class MobileAdminScreen extends StatelessWidget {
// @override
// Widget build(BuildContext context) {
//   return Scaffold(
